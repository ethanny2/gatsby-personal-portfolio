...
export const aboutData = {
  ...
  paragraphThree: 'Currently seeking remote full stack / frontend JavaScript opportunities!',
...
export const projectsData = [
  ...
  },
  {
    ...
    info: 'Video game site made using Webpack 5, SCSS, and the LAMP stack. REST API made with PHP Silex. The concept for this site was to give video game players/fans the ability to programmatically search/filter through a comprehensive game database.',
    info2:
  ...
  },
  {
    ...
    info: 'An informational fan site made with PHP scraping, SoundCloud & YouTube iframes, Bootstrap, SCSS, Masonry.js , and Webpack 5 for optimizations.',
    info2: `The original concept for the site, as instructed by a client, was to make a site for them to promote their music. Later that agreement fell through but since I had already made the site I just replaced the subject matter with a trending artist at the time.
            This site is meant to have an old-school grungy aesthetic with the use of a non-traditional background , animated transparent gifs and other flourishes. Similar to the website style of the popular fasion brand AWGE.`,
